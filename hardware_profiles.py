...
GPU_SKUS: list[dict[str, Any]] = [
    {"name": "RX 7900 XTX", "family": "rdna3", "score": 85, "vram_gbps": 960, "class": "enthusiast",
     "patterns": ("7900 XTX", "7900XTX"), "boost_mhz": 2500},
    {"name": "RX 7900 XT", "family": "rdna3", "score": 76, "vram_gbps": 800, "class": "enthusiast",
     "patterns": ("7900 XT", "7900XT"), "boost_mhz": 2400},
    {"name": "RX 7800 XT", "family": "rdna3", "score": 66, "vram_gbps": 624, "class": "upper",
     "patterns": ("7800 XT", "7800XT")},
    {"name": "RX 7700 XT", "family": "rdna3", "score": 60, "vram_gbps": 432, "class": "upper",
     "patterns": ("7700 XT", "7700XT")},
    {"name": "RX 7600 XT", "family": "rdna3", "score": 52, "vram_gbps": 288, "class": "mid",
     "patterns": ("7600 XT", "7600XT")},
    {"name": "RX 7600", "family": "rdna3", "score": 46, "vram_gbps": 288, "class": "mid",
     "patterns": ("RX 7600",)},
    {"name": "RX 6950 XT", "family": "rdna2", "score": 72, "vram_gbps": 576, "class": "enthusiast",
     "patterns": ("6950 XT", "6950XT")},
    {"name": "RX 6900 XT", "family": "rdna2", "score": 70, "vram_gbps": 512, "class": "enthusiast",
     "patterns": ("6900 XT", "6900XT")},
    {"name": "RX 6800 XT", "family": "rdna2", "score": 64, "vram_gbps": 512, "class": "upper",
     "patterns": ("6800 XT", "6800XT")},
    {"name": "RX 6800", "family": "rdna2", "score": 58, "vram_gbps": 512, "class": "upper",
     "patterns": ("RX 6800",)},
    {"name": "RX 6700 XT", "family": "rdna2", "score": 48, "vram_gbps": 384, "class": "mid",
     "patterns": ("6700 XT", "6700XT")},
    {"name": "RX 6650 XT", "family": "rdna2", "score": 42, "vram_gbps": 280, "class": "mid",
     "patterns": ("6650 XT", "6650XT")},
    {"name": "RX 6600 XT", "family": "rdna2", "score": 40, "vram_gbps": 256, "class": "mid",
     "patterns": ("6600 XT", "6600XT")},
    {"name": "RX 6600", "family": "rdna2", "score": 36, "vram_gbps": 224, "class": "mid",
     "patterns": ("RX 6600",)},
    {"name": "RX 6500 XT", "family": "rdna2", "score": 28, "vram_gbps": 144, "class": "entry",
     "patterns": ("6500 XT", "6500XT")},
    {"name": "RX 5700 XT", "family": "rdna1", "score": 44, "vram_gbps": 448, "class": "mid",
     "patterns": ("5700 XT", "5700XT")},
    {"name": "RX 5700", "family": "rdna1", "score": 40, "vram_gbps": 448, "class": "mid",
     "patterns": ("RX 5700",)},
    {"name": "RX 5600 XT", "family": "rdna1", "score": 34, "vram_gbps": 288, "class": "mid",
     "patterns": ("5600 XT", "5600XT")},
    {"name": "RX 580", "family": "polaris", "score": 24, "vram_gbps": 256, "class": "entry",
     "patterns": ("RX 580", "RADEON RX 580")},
    {"name": "RX 570", "family": "polaris", "score": 20, "vram_gbps": 224, "class": "entry",
     "patterns": ("RX 570",)},
    {"name": "RX 480", "family": "polaris", "score": 18, "vram_gbps": 256, "class": "entry",
     "patterns": ("RX 480",)},
    {"name": "RTX 5090", "family": "nvidia", "score": 100, "vram_gbps": 1792, "class": "flagship",
     "patterns": ("RTX 5090", "5090")},
    {"name": "RTX 4090", "family": "nvidia", "score": 92, "vram_gbps": 1008, "class": "flagship",
     "patterns": ("RTX 4090", "4090")},
    {"name": "RTX 4080 Super", "family": "nvidia", "score": 82, "vram_gbps": 736, "class": "enthusiast",
     "patterns": ("RTX 4080 SUPER", "4080 SUPER", "RTX 4080", "4080")},
    {"name": "RTX 4070 Ti Super", "family": "nvidia", "score": 70, "vram_gbps": 672, "class": "upper",
     "patterns": ("4070 TI SUPER", "4070 TI", "4070TI")},
    {"name": "RTX 4070", "family": "nvidia", "score": 58, "vram_gbps": 504, "class": "upper",
     "patterns": ("RTX 4070",)},
    {"name": "RTX 4060", "family": "nvidia", "score": 44, "vram_gbps": 272, "class": "mid",
     "patterns": ("RTX 4060", "4060")},
    {"name": "RTX 3090", "family": "nvidia", "score": 78, "vram_gbps": 936, "class": "enthusiast",
     "patterns": ("RTX 3090", "3090")},
    {"name": "RTX 3080", "family": "nvidia", "score": 68, "vram_gbps": 760, "class": "upper",
     "patterns": ("RTX 3080", "3080")},
    {"name": "RTX 3070", "family": "nvidia", "score": 54, "vram_gbps": 448, "class": "upper",
     "patterns": ("RTX 3070", "3070")},
    {"name": "RTX 3060 12GB", "family": "nvidia", "score": 38, "vram_gbps": 360, "class": "mid",
     "patterns": ("RTX 3060", "3060")},
    {"name": "GTX 1660 Super", "family": "nvidia", "score": 22, "vram_gbps": 192, "class": "entry",
     "patterns": ("1660 SUPER", "GTX 1660", "1660")},
    {"name": "GTX 1080", "family": "nvidia", "score": 26, "vram_gbps": 320, "class": "entry",
...
def merge_gpu_profile(
    *,
    ...
    profile: dict[str, Any] = {
        ...
        "fan_curve_note": family.get("fan_curve_note") or (
...
def _gpu_relevant_text(text: str) -> str:
    ...
    for line in text.splitlines():
        ...
        if any(
            token in low
            for token in (
                "vga", "3d", "display", "radeon", "geforce", "nvidia",
                "amd/ati", "1002:", "10de:", "subsystem",
            )
        ):
            lines.append(line)
    return "\n".join(lines)
